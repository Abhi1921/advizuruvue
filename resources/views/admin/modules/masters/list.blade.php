...
<meta content="Masters" name="description" />
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <button class="btn btn-primary w-md waves-effect waves-light saveBtn"
                                            type="button" onclick="searchMastersList()">Search</button>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 ">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-2">
                                    <a href="{{route('masters.create')}}" ><button class="btn btn-primary w-md waves-effect waves-ligh"
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-0" id="record-list" data-url="{{route('masters.list')}}">
                                <thead>
                                    <tr>
                                        <th>Sr. No.</th>
                                        <th>Name</th>
...
<script type="text/javascript">
    var searchUrl = "{{route('masters.list')}}"
    var listUrl = "{{route('masters.index')}}"
    var deleteUrl = "{{route('masters.delete')}}"
    var changeUrl = "{{route('masters.status')}}"
</script>
