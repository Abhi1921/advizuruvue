                            ...
                            <div class="col-sm-12 ">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <label for="example-text-input" class="col-form-label">Country Name</label>
                                        <input class="form-control" id="user_name" type="text" name="country"
                                            value="{{$name ? $name : ''}}">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 ">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-2">
                                    <a href="{{route('countries.create')}}" ><button class="btn btn-primary w-md waves-effect waves-ligh"
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-0" id="record-list" data-url="{{route('countries.list')}}">
                                <thead>
                                    <tr>
                                        <th>Sr. No.</th>
                                        <th>ID</th>
...
<script type="text/javascript">
    var searchUrl = "{{route('countries.list')}}"
    var listUrl = "{{route('countries.index')}}"
    var deleteUrl = "{{route('countries.delete')}}"
    var changeUrl = "{{route('countries.status')}}"
</script>
