...
<meta content="States" name="description" />
                            ...
                            <div class="col-sm-12 ">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input class="form-control" id="user_name" type="text" name="state"
                                            value="{{$name ? $name : ''}}">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 ">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-2">
                                    <a href="{{route('states.create')}}" ><button class="btn btn-primary w-md waves-effect waves-ligh"
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-0" id="record-list" data-url="{{route('states.list')}}">
                                <thead>
                                    <tr>
                                        <th>Sr. No.</th>
                                        <th>ID</th>
...
<script type="text/javascript">
    var searchUrl = "{{route('states.list')}}"
    var listUrl = "{{route('states.index')}}"
    var deleteUrl = "{{route('states.delete')}}"
    var changeUrl = "{{route('states.status')}}"
</script>
